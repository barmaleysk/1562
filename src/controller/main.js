  ...
  sendCallback (msg, item) {
    ...
    switch (item) {
      ...
      case 'packaging':
        ...
        break
      case 'bots':
        text = `Боты - новый рынок, который моментально генерирует прибыль!/nДоставка еды, крипто-боты, скачивание онлайн-книг бесплатно./nБольшой спрос на данную услугу./nНаша команда - создаёт хорошо продуманные РЕШЕНИЯ./nМы готовы взять взятся за Ваш проект уже прямо сегодня!/nЗаказывайте - через товар, либо /expert /nВ этом месяце уже взяли: 4 проекта./nПомогаем таким же людям, как Вы!`
        keyboard = {
          inline_keyboard: [
